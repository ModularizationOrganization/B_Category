...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/ModularizationOrganization/B_Category"
  ...
  s.source       = { :git => "https://github.com/ModularizationOrganization/B_Category.git", :tag => s.version.to_s }
